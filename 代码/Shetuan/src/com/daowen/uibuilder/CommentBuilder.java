...
public class CommentBuilder {
	...
	public String getComments(String type, String belongid) {
		...
		for (Iterator<Comment> it = list.iterator(); it.hasNext();) {
			...
			String times = "";
			long day =  (new Date().getTime() - c.getCommenttime()
					.getTime()) / (60 * 60 * 1000*24);
			long hour =  (new Date().getTime() - c.getCommenttime()
					.getTime()) / (60 * 60 * 1000);
			long minuter = (long) (new Date().getTime() - c.getCommenttime()
					.getTime()) / (60 * 1000);
