...
<h2>
				    ...
				    <form name="acttypeform"  method="post" action="${pageContext.request.contextPath}/admin/acttypemanager.do"  id="acttypeForm">
				        <table class="grid" cellspacing="1" width="100%">
						        <input type="hidden" name="id" value="${id}" />
						        <input type="hidden" name="actiontype" value="${actiontype}" />
						         <input type="hidden" name="seedid" value="${seedid}" />
						         <input type="hidden" name="errorurl" value="/admin/acttypeadd.jsp" />
						        <input type="hidden" name="forwardurl" value="/admin/acttypemanager.do?actiontype=get&forwardurl=/admin/acttypemanager.jsp" />
						        <tr>
								  <td colspan="4">
								      ${errormsg}
								  </td>
											   ...
											   <td>
												   <input name="name" placeholder="名称" validate="{required:true,messages:{required:'请输入名称'}}" value="${requestScope.acttype.name}" class="input-txt" type="text" id="txtName"  />
												</td>
											   </tr>
						   <tr>
						       <td colspan="4">
